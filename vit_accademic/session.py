...
class session(models.Model):
    ...
    total_attendee = fields.Integer(compute="_calc_total_attendee",
                                string="Total Attendees", required=False, )
    ...
    def _calc_total_attendee(self):
        for rec in self:
            rec.total_attendee = len(rec.attendee_ids)
